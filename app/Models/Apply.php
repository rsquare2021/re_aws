    ...
    public function changeStatus($new_status)
    {
        ...
        switch($new_status) {
            ...
            case ApplyStatus::WAITING_LOTTERY:
                if($old != ApplyStatus::APPLYING) throw new Exception("");
                break;
            case ApplyStatus::LOST_LOTTERY:
                ...
                if(!$is_lost_instant and !$is_lost_bulk) throw new Exception("");
                break;
            case ApplyStatus::WAITING_ADDRESS:
                ...
                if(!$is_catalog and !$is_winning) throw new Exception("");
                break;
            case ApplyStatus::CANCEL:
                ...
                if(!$is_waiting_lottery and !$is_waiting_address) throw new Exception("");
                break;
            case ApplyStatus::SENT_PRODUCT:
                if($old != ApplyStatus::WAITING_ADDRESS) throw new Exception("");
                break;
