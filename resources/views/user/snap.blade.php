...
@section('content')
    ...
    <div class="user_wrap">
        ...
        <input type="hidden" id="start_time" value="{{ $campaign->start_datetime_to_convert_receipts_to_points->format('Ymd') }}">
        <input type="hidden" id="end_time" value="{{ $campaign->end_datetime_to_convert_receipts_to_points->format('Ymd') }}">
        <div id="snap_caution">
