            ...
            <ul class="swiper-wrapper">
                @foreach ($recommends as $recommend)
                    <li class="swiper-slide">
                        ...
                        @endif
                            <div class="img"><img src="/uploads/{{$campaign->id}}/{{ $recommend->product->operation_id }}.png"></div>
        ...
        <ul class="lineup products">
            @foreach ($gifts as $gift)
                <li>
                    ...
                    @endif
                        <div class="img"><img src="/uploads/{{$campaign->id}}/{{ $gift->product->operation_id }}.png"></div>
