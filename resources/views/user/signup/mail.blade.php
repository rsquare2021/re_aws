                                ...
                                <div id="register_input">
                                    ...
                                    <div class="form p-3">
                                        ...
                                        <div id="username-field" class="field-wrapper input">
                                            ...
                                            <div class="relative">
                                                <input id="username" name="email" type="text" class="form-control required" placeholder="yourname@next-cp.com">
                                        ...
                                        <div id="username-field" class="field-wrapper input mt-3">
                                            ...
                                            <div class="relative">
                                                <input id="username_confirm" name="email_confirmation" type="text" class="form-control required" placeholder="yourname@next-cp.com">
                                                <check class="mail_check_mark"></check>
                                            </div>
                                        </div>
                                        <div id="password-field" class="field-wrapper input mb-2 mt-3">
                                            <div class="d-flex justify-content-between">
                                                <label for="password">パスワード <small>※半角英数字の組み合わせで8桁以上</small></label>
                                            </div>
                                            <div class="relative">
